...
def main(
    ...
    if 'VDC' in dataset:
        ...
        if ('Gukbap-Gemma3' in base_model) or ('gemma-3' in base_model):
            ...
            average, type1_avg, type2_avg = VDC_Eval(eval_dataset, model, image_path, None, None, 'ovis2.5', thinking_mode)

        elif ('Ovis' in base_model) or ('Gukbap' in base_model):
            average, type1_avg, type2_avg = VDC_Eval(eval_dataset, model, image_path, text_tokenizer, visual_tokenizer, 'ovis')
