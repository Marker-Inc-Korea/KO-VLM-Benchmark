# Introduction😋
해외에서 멀티모달에 대한 관심이 커짐에 따라 foundation model 및 benchmark dataset이 다양하게 제작되고 공유되고 있습니다.  
하지만, 해외 multimodal benchmark 경우 대부분의 input/output이 `영어`가 기준이다보니, 한국어 능력에 대한 평가를 정확하게 할 수 없습니다.😵   
